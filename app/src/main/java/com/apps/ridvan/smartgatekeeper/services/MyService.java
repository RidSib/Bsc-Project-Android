package com.apps.ridvan.smartgatekeeper.services;
...
import com.apps.ridvan.smartgatekeeper.model.LoginData;
...
public class MyService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        Gson gson = new Gson();
        LoginData[] dataItems = gson.fromJson(response, LoginData[].class);
